...
export class AgentsController {
  ...
  async resume(
    ...
    const agent = await this.agentsService.updateStatus(id, AgentStatus.IDLE);
    return {
      success: true,
  ...
  archive(@Param('id', ParseUUIDPipe) id: string) {
    return this.agentsService.setStatus(id, 'ARCHIVED');
  }

  @Patch(':id/deprecate')
  @Roles(UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.ADMIN)
  deprecate(@Param('id', ParseUUIDPipe) id: string) {
    return this.agentsService.setStatus(id, 'DEPRECATED');
  }

  @Patch(':id/restore')
  @Roles(UserRole.SUPER_ADMIN, UserRole.OWNER, UserRole.ADMIN)
  restore(@Param('id', ParseUUIDPipe) id: string) {
    return this.agentsService.setStatus(id, 'IDLE');
  }
