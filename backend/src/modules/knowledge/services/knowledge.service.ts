...
export class KnowledgeService {
  ...
  async create(
    ...
    return this.findOneOrThrow(entry.id);
  }

  async findOneOrThrow(id: string): Promise<KnowledgeEntry> {
    const tenantId = this.tenantContext.tenantId;
  ...
  async update(
    ...
    return this.findOneOrThrow(updated.id);
  }
  ...
  async list(dto: ListKnowledgeDto) {
    const tenantId = this.tenantContext.tenantId;
  ...
  async listCitationsFor(entryId: string) {
    const tenantId = this.tenantContext.tenantId;
