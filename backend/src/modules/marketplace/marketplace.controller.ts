...
export class MarketplaceController {
  ...
  async tabs() {
    return this.marketplace.getSummary();
  }
  ...
  async items(@Query() query: BrowseMarketplaceDto) {
    const tab = (query.tab ?? 'packs') as MarketplaceTab;
    return this.marketplace.browseTab({
      tab,
      q: query.q,
  ...
  async listPacks() {
    return this.solutionPacks.listCatalog({});
  }
  ...
  async agentTemplates() {
    return this.marketplace.browseTab({ tab: 'agent-templates' });
  }
  ...
  async connectors() {
    return this.marketplace.browseTab({ tab: 'connectors' });
  }
  ...
  async workflows() {
    return this.marketplace.browseTab({ tab: 'workflows' });
  }
  ...
  async knowledgePacks() {
    return this.marketplace.browseTab({ tab: 'knowledge-packs' });
  }
